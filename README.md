...
Food Ordering & Cart System
  ...
  - Increase or decrease item quantities directly in the cart
...
Customer name, Order number, Delivery address, Total amount in Pakistani Rupees (₨), Estimated delivery time
 ...
 Wishlist System
  ...
  - Toggle items on/off the wishlist with a heart icon
  - View all saved items on a dedicated Wishlist Page
  - Remove individual items or clear the entire wishlist
  - Add items to cart directly from the wishlist

 Dark / Light Mode
  - Toggle using a moon/sun icon in the navbar for light/dark mode
 ...
 Home Page
  ...
  - “Order Now” button to explore restaurants
  - “Explore Now” button to scroll to the About section
  - About section highlighting key features: Fresh Ingredients, Fast Delivery, Best Quality
  - Popular food categories display
 ...
 Footer Section
  ...
  - Easy access to support details
